...
<script>
    ...
    var urlBase = "/Proyecto-AmbienteWeb-G9/public/index.php";
    ...
    if (idSesion === 0 || idSesion === null) {
        console.error("ERROR CRÍTICO: idSesion es 0!");
        alert("Error: No se pudo iniciar la sesión del examen. Por favor, recarga la página.");
    }
</script>

<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="<?php echo $baseUrl; ?>js/examen.js"></script>
